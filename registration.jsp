	...
	<script type="text/javascript">
		function checkStatus() {
			...
			if (status == "success") {
				...
				swal("OOPs", "Please Enter the Name","error");
			}
			else	if (status == "InvalidEmail") {
				swal("OOPs", "Please Enter the Mail","error");
			}
			else if (status == "Invalidupwd") {
				swal("OOPs", "Please Enter the Password","error");
			}
			else	if (status == "InvalidMobile") {
				swal("OOPs", "Please Enter the Mobile","error");
			}
			else	if (status == "InvaliduConfirmpwd") {
				swal("OOPs", "Mismatch Password","error");
			}
